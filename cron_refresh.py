...
def _via_db() -> int:
    if not os.environ.get("MASTER_DB"):
        print("[cron] neither APP_URL nor MASTER_DB set — nothing to do.")
        return 1
    print("[cron] APP_URL not set — building in-process and saving to Postgres.")
